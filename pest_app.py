...
# Colour palette for chart bars (one per class)
BAR_COLORS = ['#52b788', '#74c69d', '#95d5b2', '#b7e4c7', '#d8f3dc', '#40916c']

# 3. Load model
@st.cache_resource
def load_my_model():
    return tf.keras.models.load_model('agricultural_pest_model.keras')
...
if uploaded_file is not None and model_loaded:
    ...
    scores = predictions[0]                        # raw confidence scores
